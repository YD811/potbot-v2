...
export default function ReferralPanel({ potPubkey, potName }: Props) {
  ...
  const [copiedLevel2, setCopiedLevel2] = useState(false)
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-pot-card border border-pot-border rounded-2xl p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          <div className="flex-1 h-6 rounded-full overflow-hidden flex text-[10px] font-bold">
            <div className="bg-pot-green flex items-center justify-center text-pot-dark" style={{ width: '70%' }}>
              70% Creator
            </div>
            <div className="bg-pot-accent flex items-center justify-center text-white" style={{ width: '20%' }}>
              20%
            </div>
            <div className="bg-yellow-400 flex items-center justify-center text-pot-dark" style={{ width: '10%' }}>
              10%
            </div>
          </div>
        </div>
      ...
      <div className="bg-pot-card border border-pot-border rounded-2xl p-5 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-pot-muted font-mono bg-pot-dark px-2 py-0.5 rounded-full">
            ref: {shortRef}
          </span>
        </div>
      ...
      {/* 2-level system explained */}
      <div className="bg-pot-card border border-pot-border rounded-2xl p-5 space-y-4">
        <h3 className="text-sm font-semibold text-white">2-Level Referral System</h3>
        <div className="space-y-3">
          {/* Level 1 */}
          <div className="flex gap-3 items-start">
            <div className="w-8 h-8 rounded-full bg-pot-green/20 text-pot-green flex items-center justify-center font-bold text-sm shrink-0">
              1
            </div>
            <div>
              <p className="text-sm font-semibold text-white">Direct referral — 10%</p>
              <p className="text-xs text-pot-muted mt-0.5">
                Someone joins using your link → you earn 10% of their entry fee instantly.
              </p>
            </div>
          </div>
          {/* Arrow */}
          ...
          <div className="flex gap-3 items-start ml-4">
            <div className="w-8 h-8 rounded-full bg-pot-accent/20 text-pot-accent flex items-center justify-center font-bold text-sm shrink-0">
              2
            </div>
            <div>
              <p className="text-sm font-semibold text-white">Sub-referral — 2%</p>
              <p className="text-xs text-pot-muted mt-0.5">
                Your referral invites someone else → you earn 2% of their entry fee too.
              </p>
            </div>
          </div>
        </div>
            ...
            {stats.referralList.map((r, i) => (
              <div key={i} className="flex items-center justify-between py-2 border-b border-pot-border/50 last:border-0">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-mono text-pot-muted">
