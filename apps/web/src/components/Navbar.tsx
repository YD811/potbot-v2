      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden sm:flex items-center gap-1 text-sm font-medium">
          {NAV_LINKS.map(({ href, label }) => (
            <Link
              ...
              className={`px-3 py-1.5 rounded-lg transition ${
                isActive(href)
                  ? 'text-white bg-pot-card border border-pot-border'
                  : 'text-gray-400 hover:text-white hover:bg-pot-card/50'
              }`}
            >
              {label}
            </Link>
          ...
          {publicKey && (
            <Link
              ...
              className={`px-3 py-1.5 rounded-lg transition ${
                isActive('/my-pots')
                  ? 'text-pot-accent bg-pot-accent/10 border border-pot-accent/30'
                  : 'text-gray-400 hover:text-white hover:bg-pot-card/50'
              }`}
            >
              My POTs
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="sm:hidden ml-1 p-2 rounded-lg text-pot-muted hover:text-white hover:bg-pot-card transition"
